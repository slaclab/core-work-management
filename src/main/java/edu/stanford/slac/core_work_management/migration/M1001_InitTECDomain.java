                ...
                NewWorkTypeDTO.builder()
                        ...
                        .customFields(
                                List.of(
                                        ...
                                        WATypeCustomFieldDTO.builder().label("radiationSafetyWorkControlForm").description("Radiation Safety Work Control Form").valueType(ValueTypeDTO.Boolean).group("Required Safety Forms or Controls").isMandatory(true).build(),
                                        WATypeCustomFieldDTO.builder().label("lockAndTag").description("Lock and Tag").valueType(ValueTypeDTO.Boolean).group("Required Safety Forms or Controls").isMandatory(true).build(),
