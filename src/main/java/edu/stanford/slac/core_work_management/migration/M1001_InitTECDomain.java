                ...
                NewWorkTypeDTO.builder()
                        ...
                        .customFields(
                                List.of(
                                        ...
                                        WATypeCustomFieldDTO.builder().label("Request Description").description("Request Description").valueType(ValueTypeDTO.String).group("Background Information").isMandatory(false).build(),
